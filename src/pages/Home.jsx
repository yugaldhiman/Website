...
const Home = () => {
    ...
    const services = [
        ...
        { id: 6, name: 'INDIRECT TAX / GST', description: 'Indirect taxes apply to goods and services, with consumers bearing the cost. GST is a unified tax that replaced multiple indirect taxes like VAT and excise. It operates through various rates (5%, 12%, 18%, 28%) and allows input tax credits to businesses. GST simplifies compliance, enhances transparency, and reduces tax evasion. It also fosters economic growth by unifying the national market.' },
        { id: 7, name: 'Startup/New Business', description: "India is second most developing country in startups and therefore this sector is growing at its fastest pace. Government’s “Startup India & Standup India' Scheme fuels this pace. We at Arpit Gupta & Co. help startup many ways in getting the maximum benefits of government scheme and services. Following are few of them:" },
        { id: 8, name: 'Registration & Return Services', description: 'We provide services of registration under various revenue laws as well as intellectual property laws and other business laws, some of them are as follows' },
        { id: 9, name: 'Business Consultancy Services', description: 'Profit maximization is the objective of any business. We, at Arpit Gupta & Co., provide services to help the business owners to run their business smoothly and efficiently resulting in maximum profits. These services are structured to suit an individual client’s needs and requirements. The services can be categorized as follows:' },
