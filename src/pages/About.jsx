...
//                     <h5>Rajan Dhiman</h5>
//                     <p className="education-p">Chartered Accountant and Advocate</p>
//                     <div className="aboutLeftTextBox">
//                         <p>
//                             Rajan Dhiman is a distinguished Chartered Accountant and Advocate
//                             with a wealth of experience in finance, taxation, and legal
//                             advisory services. Known for his meticulous approach, he has built
//                             a reputation for providing comprehensive solutions tailored to the
//                             needs of businesses and individuals alike. His dual expertise
//                             enables him to bridge the gap between financial and legal
//                             intricacies, offering unparalleled guidance in compliance, audits,
//                             and litigation matters.
//                         </p>
//                         <p>
//                             With a passion for excellence, Rajan has successfully represented
//                             clients in high-stakes cases and has played a pivotal role in
//                             optimizing their financial strategies. He is also committed to
//                             educating clients on complex regulatory changes, ensuring their
//                             interests are protected. His integrity, dedication, and
//                             client-centric approach make him a trusted partner in navigating
//                             financial and legal challenges.
//                         </p>
//                         <p>
//                             Rajan Dhiman continues to inspire trust and confidence among his
//                             clients with his unwavering commitment to professionalism and
//                             quality service.
//                         </p>
//                     </div>
//                 </div>
...
//                         <h2>Our Vision</h2>
//                         <p>
//                             <span>*</span> To be significantly present in all the regions of the country as
//                             a, national, professional Firm of repute, addressing primarily the
//                             mid-sized and large Corporate segments and all those
//                             entrepreneurial-individuals who create and drive the economic
//                             growth of the country irrespective of size.
//                         </p>
//                         <p>
//                             <span>*</span> To provide balanced and rounded threefold services in the
//                             related areas of professional practice: audit, tax and consulting,
//                             at all practice locations.
//                         </p>
//                         <p>
//                             <span>*</span> To be a competitive & dynamic leader in the areas of operation,
//                             so that the best opportunity to progress and grow at all levels is
//                             available to all associated with the Firm, thereby directly
//                             serving the best-interests of the Firm’s clients; and to develop
//                             and implement strategies towards that end.
//                         </p>
//                     </div>
//                     <div className="abiutRightBox-2">
//                         <h2>Our Values</h2>
//                         <p>
//                             <span>*</span> To uphold high standards of honesty and integrity that makes the
//                             individual and collective actions of those who work for the Firm
//                             fruitful to our client.
//                         </p>
//                         <p>
//                             <span>*</span> To place the interest of individuals and that of clients’ ahead
//                             of that of the Firm whenever the need arises to differentiate
//                             between these interests.
//                         </p>
//                         <p>
//                             <span>*</span> To strive always to improve the quality of services, driven by
//                             the larger need, internal and external, to improve the quality of
//                             life and the standard of living, for society as a whole.
//                         </p>
//                     </div>
//                 </div>
//             </div>
